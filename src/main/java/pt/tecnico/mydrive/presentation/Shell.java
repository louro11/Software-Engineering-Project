...
/* o printwriter e um objecto java, que serve para manipular ficheiros (classes) file do java e imprimir cenas de la */
  ...
  /* vai buscar um comando apartir de um nome*/
  ...
  public void execute() throws Exception {
    ...
    /* ultimo print para fechar a shell */
